...
@Injectable()
export class tripstarservice {
    Signup = "Sign Up";
    Login = "Log In";
    UserID = ''; UserType = ''; ShowNotifyMsg = ''; showMessage: any = []; openhstID: any; bookingID = ''; bookingstatu = '';
